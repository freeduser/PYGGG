...
import com.pinyougou.content.interfaces.ContentCategoryService;
...
public class ContentCategoryController {
	...
	public PageResult search(@RequestBody(required = false) TbContentCategory contentCategory, int page, int rows  ){
